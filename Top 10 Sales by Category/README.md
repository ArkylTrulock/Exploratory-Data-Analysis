...
-----------------------------
A data analysis project using pandas to categorize and highlight sales data, returning the top 10 items in each category.

## Overview
-----------
This project provides a complete workflow for loading, cleaning, and analyzing sales data. By grouping data into meaningful categories and highlighting key insights (such as negative values), it presents an easily interpretable view of the top 10 items in each category.
...
6) Group Data: Group the data by category and return the top 10 items for each group.
